...
export function PageHero({ children, className, containerClassName }: PageHeroProps) {
  return (
    <section 
      className={cn(
    ...
    >
      ...
      <div className={cn("container mx-auto px-4 relative z-10 text-center", containerClassName)}>
        {children}
      </div>
    </section>
  );
