...
export function RoundControls({
  ...
  return (
    <div className={`flex items-center justify-center md:justify-start transition-all duration-300 ${
      ...
      <div className={`rounded-lg bg-linear-to-r from-blue-600 to-purple-600 text-white font-bold font-(family-name:--font-bebas-neue) whitespace-nowrap transition-all duration-300 ${
        compact 
