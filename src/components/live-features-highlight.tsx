...
export function LiveFeaturesHighlight({
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Cast your vote after each round to impact the battle's outcome.",
  ...
  return (
    <section className="pt-12 pb-24 px-4 relative overflow-hidden bg-black border-y border-white/5">
      {/* Background Elements */}
