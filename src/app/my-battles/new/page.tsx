...
export default function NewUserBattlePage() {
    ...
    try {
      ...
      const response = await fetch("/api/battle/create", {
        ...
        body: JSON.stringify({
          ...
          isFeatured: false, // User battles are not featured
        }),
    ...
    <>
      ...
      <div className="min-h-[calc(100vh-3.5rem)] bg-linear-to-b from-gray-950 via-gray-900 to-black flex flex-col items-center p-6 py-12">
        ...
        <div className="w-full max-w-7xl mx-auto mb-8">
          <h1 className="font-bebas text-6xl text-center mb-4 text-white">
            Create Your Battle
          </h1>
          <p className="text-center text-gray-400 text-lg">
            Select two AI personas to battle
          </p>
        </div>
        ...
        <button
          ...
          className={`px-8 py-4 rounded-lg font-bebas text-2xl transition-all ${
